...
async def evaluate_continuity():
    ...
    logger.info("Evaluating Continuity Agent on canary script (%d pages)...", page_count)
    ...
    try:
        ...
        for i_gt, gt in enumerate(ground_truth):
            ...
            gt_page_violated = gt["violated_page"]
            ...
            for i_det, det in enumerate(detected):
                ...
                page_match = det_page_violated is not None and abs(det_page_violated - gt_page_violated) <= 1
